    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('firstName', models.CharField(blank=True, default='React', max_length=256, null=True)),
                ('lastName', models.CharField(blank=True, default='Native', max_length=256, null=True)),
